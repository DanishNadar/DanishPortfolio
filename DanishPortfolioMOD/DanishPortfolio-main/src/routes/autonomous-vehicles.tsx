...
function AutonomousVehiclesPage() {
  return (
    <MotionPage mood="autonomy" tone="systems" className="mx-auto max-w-[92rem] px-6 lg:px-10 py-14 readable-page">
      ...
      <section className="autonomy-story-grid mt-12 grid lg:grid-cols-[0.95fr_1.05fr] gap-8 items-stretch">
        <ImageSlot
          id="AV-STORY"
      ...
      <section className="autonomy-story-grid mt-12 grid lg:grid-cols-[1.05fr_0.95fr] gap-8 items-stretch">
        <div className="glass premium-border rounded-3xl p-7 md:p-9">
      ...
      <section className="autonomy-thesis-grid mt-20 grid lg:grid-cols-[0.92fr_1.08fr] gap-8 items-stretch">
        <div className="glass premium-border rounded-3xl p-8 flex flex-col justify-center">
        ...
        <div className="autonomy-thesis-images grid md:grid-cols-2 gap-5">
      ...
      <section className="mt-20">
        <div className="text-xs uppercase tracking-[0.18em] text-accent font-tech">Field evidence</div>
