          ...
          return (
            ...
            >
              <Link
                to="/projects/$slug"
                params={{ slug: p.slug }}
                data-visual-theme={projectVisualTheme(p.domain)}
                className="semantic-color-card group block glass premium-border ambient-card rounded-[1.85rem] p-0 h-full min-h-[25rem] transition hover:-translate-y-1 overflow-hidden"
              >
                <ImmersiveImage
                  src={visual}
                ...
                <div className="p-8 md:p-9">
                  <div className="flex items-center justify-between mb-3 gap-2">
                    <span className="semantic-color-badge text-xs px-2 py-0.5 rounded-full text-white font-semibold">
