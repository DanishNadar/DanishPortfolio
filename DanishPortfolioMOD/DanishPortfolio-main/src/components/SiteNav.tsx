              ...
              <div className="flex items-center justify-between gap-4 border-b border-border/60 px-5 py-3 bg-gradient-to-r from-blue-500/12 via-transparent to-rose-800/12">
                ...
                <div className="flex shrink-0 items-center gap-2">
                  <Link
                    to="/student-organizations"
                    onClick={close}
                    className="inline-flex items-center gap-1.5 rounded-lg bg-gradient-rb px-3 py-1 text-xs font-semibold text-background hover:brightness-110 transition"
                  >
                  ...
                  <div key={label}>
                    ...
                    {groupLinks.map(({ to, label: linkLabel, description, featured }) => (
                      <Link
                        ...
                        to={to}
                        onClick={close}
                        className={`flex items-start gap-3 px-5 py-3 text-sm transition-colors duration-150 border-b border-border/20 last:border-0 group/item ${
                          featured
                            ? "bg-gradient-to-r from-rose-500/12 via-blue-500/10 to-transparent hover:from-rose-500/18 hover:via-blue-500/15"
                            : "hover:bg-muted/55"
                        }`}
                      >
                        {featured && (
                          <span className="mt-0.5 grid h-8 w-8 shrink-0 place-items-center rounded-xl bg-gradient-rb text-background shadow-lg shadow-blue-950/30">
