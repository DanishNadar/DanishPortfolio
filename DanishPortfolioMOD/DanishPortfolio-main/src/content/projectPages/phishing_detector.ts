...
export const project: ProjectPageContent = {
  ...
  "subtitle": "A cybersecurity ML project for detecting suspicious/phishing communication patterns.",
  "heroStatement": "Text features, classification, evaluation, and scam-awareness application.",
  "pageTheme": {
    "eyebrow": "Security ML",
  ...
  "problem": "This chapter explains the practical security ml problem, why it matters to people or teams, and what technical choices helped turn the idea into something more useful.",
  ...
  "whatIBuilt": [
    "Text features, classification, evaluation, and scam-awareness application.",
  ...
  "stackMap": [
    {
      ...
      "usedFor": "Used directly or conceptually in Phishing Detection Model."
    },
    {
      "name": "NLP",
      "category": "Project stack",
  ...
  "implementationDetails": [
    {
      "title": "Core workflow",
      "body": "Text features, classification, evaluation, and scam-awareness application."
    },
    {
  ...
  "metrics": [
    {
      "label": "Phishing detection F1 score",
      "value": "—",
      "note": "Harmonic mean of precision and recall on the held-out phishing/scam test set"
    },
    {
      "label": "False positive rate",
      "value": "—",
      "note": "Percentage of legitimate messages incorrectly flagged as phishing"
    }
  ],
  "gallery": [
    {
      "src": "/portfolio_images/articles/scammantha-article.jpg",
      "alt": "Project visual for Phishing Detection Model",
  ...
  "relatedPostSlugs": [],
  "recruiterTakeaway": "This chapter shows applied security ml work as part of a broader pattern: frame the problem, build carefully, learn honestly, and connect the result to people who can use it.",
  "interviewTalkingPoints": [
    "What problem Phishing Detection Model tries to serve.",
    "Which stack choices mattered, and where the tradeoffs showed up.",
    "What I would rebuild or strengthen in the next iteration."
  ],
  "resumeBullets": [
    "Built Phishing Detection Model, applying Python, NLP, Classification to a practical security ml workflow."
  ],
  "futureWork": [
