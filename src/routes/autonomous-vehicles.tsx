...
function AutonomousVehiclesPage() {
  return (
    <MotionPage className="la-page mx-auto max-w-[92rem] px-6 lg:px-10 py-14 readable-page">
      <section className="la-hero relative grid lg:grid-cols-[1.05fr_0.95fr] gap-10 items-center rounded-[2rem] border overflow-hidden p-8 md:p-12">
        ...
        <div>
          ...
          <p className="mt-6 text-xl leading-relaxed text-muted-foreground">
            <TechnicalHighlight text="The homepage carries the origin  -  the curiosity, the collision, the recovery. This page carries what came after: EcoCAR sensor fusion, the engineering thesis behind perception-to-decision pipelines, the validation discipline that makes autonomous systems trustworthy, and the open problems that keep the work compelling." />
          </p>
        ...
        <div className="relative grid lg:grid-cols-[1fr_auto] gap-6 items-center">
          <div>
            ...
            <p className="mt-3 max-w-4xl text-base md:text-lg leading-8 text-muted-foreground">
              <TechnicalHighlight text="Illinois Tech featured the story behind my autonomy mission: how being struck by a speeding car pushed me toward AI systems that can make transportation safer, more predictive, and more dependable in real environments." />
            </p>
          </div>
      ...
      <section className="mt-12 grid lg:grid-cols-[1.05fr_0.95fr] gap-8 items-center">
        <div className="glass premium-border rounded-3xl p-7 md:p-9">
          ...
          <p className="mt-4 text-base md:text-lg leading-8 text-muted-foreground">
            <TechnicalHighlight text="I have applied that mindset in Technology Transition Paradigm by automating SPF, DKIM, and DMARC analysis; in EcoCAR by working with vehicle signals and autonomy pipelines; in Grupo Eloria by connecting machine learning to product workflows; and in OfficePro by supporting AI and deployment systems that reduce manual setup and operational friction." />
          </p>
      ...
      <section className="mt-20">
        <div className="text-xs uppercase tracking-[0.18em] text-accent font-tech">Engineering outcomes</div>
        <h2 className="mt-3 text-3xl md:text-4xl font-display font-bold">Autonomy results, people, and direction</h2>
