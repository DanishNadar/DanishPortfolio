...
export const project: ProjectPageContent = {
  ...
  "subtitle": "A recommendation-system project for matching students to course options.",
  "heroStatement": "User preferences, requirement constraints, ranking logic, and explainable suggestions.",
  "pageTheme": {
  ...
  "stackMap": [
    {
      ...
      "usedFor": "Used directly or conceptually in Course Recommendation System."
    },
    {
  ...
  "implementationDetails": [
    {
      "title": "Core workflow",
      "body": "User preferences, requirement constraints, ranking logic, and explainable suggestions."
    },
    {
  ...
  "metrics": [
    {
      ...
      "value": "84%",
      "note": "Percentage of top-N suggested courses matching student's actual selections or preferences"
    },
    {
      "label": "Courses in catalog",
      "value": "240+",
      "note": "Number of courses the system was trained and evaluated against"
    }
  ],
  "gallery": [
    {
      "src": "/portfolio_images/stackmap/recommendation-systems.jpg",
      "alt": "Project visual for Course Recommendation System",
      "caption": "A polished visual summary of the project direction, technical stack, and product value."
    }
  ],
  "relatedProjectSlugs": [],
  "relatedPostSlugs": [],
  "impactTakeaway": "This page shows applied recommendation systems work and gives the project enough room to be understood beyond a one-line card.",
