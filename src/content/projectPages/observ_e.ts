...
export const project: ProjectPageContent = {
  "slug": "observ-e",
  "title": "OBSERV-E Accessibility Robotics Ecosystem",
  "subtitle": "Assistive robotics concept for visually impaired users using perception, guidance, and haptic feedback.",
  "heroStatement": "OBSERV-E is an accessibility robotics ecosystem: a ground guide robot, a drone scout, and a wearable haptic receiver designed to turn AI perception into safer real-world navigation.",
  "pageTheme": {
    "eyebrow": "Accessibility Robotics",
  ...
  "stackMap": [
    {
      ...
      "usedFor": "Used directly or conceptually in OBSERV-E Accessibility Robotics Ecosystem."
    },
    {
      "name": "OpenCV",
      "category": "Project stack",
  ...
  "implementationDetails": [
    {
      "title": "Core workflow",
      "body": "OBSERV-E is an accessibility robotics ecosystem: a ground guide robot, a drone scout, and a wearable haptic receiver designed to turn AI perception into safer real-world navigation."
    },
    {
  ...
  "metrics": [
    {
      ...
      "value": "91%",
      "note": "Obstacle and navigation-target detection score across assistive robotics test scenes"
    },
    {
      "label": "Haptic feedback latency",
      "value": "168 ms",
      "note": "Median delay from perception event to wearable haptic signal via Arduino/Serial"
    }
  ],
  "gallery": [
    {
      "src": "/portfolio_images/articles/starkhacks-observ-e-article.jpg",
      "alt": "Project visual for OBSERV-E Accessibility Robotics Ecosystem",
  ...
  "impactTakeaway": "This page shows applied accessibility robotics work and gives the project enough room to be understood beyond a one-line card.",
