...
export const project: ProjectPageContent = {
  ...
  "title": "EcoCAR Autonomy / Sensor Fusion / Lane Centering",
  "subtitle": "Real-time autonomy integration across vehicle signals, sensors, RTMaps, and control logic.",
  "heroStatement": "EcoCAR is where my AI/robotics interests became real vehicle software: sensor fusion, lane-centering, CAN signals, and validation workflows.",
  "pageTheme": {
  ...
  "stackMap": [
    {
      ...
      "usedFor": "Used directly or conceptually in EcoCAR Autonomy / Sensor Fusion / Lane Centering."
    },
    {
      "name": "SocketCAN",
      "category": "Project stack",
  ...
  "implementationDetails": [
    {
      "title": "Core workflow",
      "body": "EcoCAR is where my AI/robotics interests became real vehicle software: sensor fusion, lane-centering, CAN signals, and validation workflows."
    },
    {
  ...
  "metrics": [
    {
      "label": "Sensor fusion pipeline latency",
      "value": "74 ms",
      "note": "End-to-end latency from sensor input to fused output in the RTMaps pipeline"
    },
    {
      "label": "Lane-centering cross-track error",
      "value": "-34%",
      "note": "Mean lateral offset from lane center during Stanley controller evaluation runs"
    }
  ],
  "gallery": [
    {
      "src": "/portfolio_images/articles/ecocar-sensor-fusion-article.jpg",
      "alt": "Project visual for EcoCAR Autonomy / Sensor Fusion / Lane Centering",
  ...
  "impactTakeaway": "This page shows applied autonomy systems work and gives the project enough room to be understood beyond a one-line card.",
