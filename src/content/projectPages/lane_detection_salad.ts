...
export const project: ProjectPageContent = {
  ...
  "problem": "This project deserves more than a small card. The page explains the practical ml research problem, why it matters, and what technical choices were made.",
  ...
  "impactTakeaway": "This page shows applied ml research work and gives the project enough room to be understood beyond a one-line card.",
  "interviewTalkingPoints": [
    "What problem Monocular Lane Detection Improvement Study solves.",
