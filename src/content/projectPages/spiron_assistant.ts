...
export const project: ProjectPageContent = {
  ...
  "problem": "This project deserves more than a small card. The page explains the practical AI assistant problem, why it matters, and what technical choices were made.",
  ...
  "relatedPostSlugs": [],
  "impactTakeaway": "This page shows applied AI assistant work and gives the project enough room to be understood beyond a one-line card.",
  "interviewTalkingPoints": [
    "What problem Spiron Virtual Assistant solves.",
