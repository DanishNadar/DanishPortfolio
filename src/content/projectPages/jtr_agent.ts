...
export const project: ProjectPageContent = {
  "slug": "jtr-agent",
  "title": "JTR \u00b7 AI Job-Seeking Agent",
  "subtitle": "A job tracker and recommender concept for organizing applications and matching roles.",
  "heroStatement": "Application tracking, role matching, skill mapping, and recommendation logic.",
  "pageTheme": {
    "eyebrow": "Career Tech",
  ...
  "problem": "This project deserves more than a small card. The page explains the practical career tech problem, why it matters, and what technical choices were made.",
  ...
  "whatIBuilt": [
    "Application tracking, role matching, skill mapping, and recommendation logic.",
  ...
  "stackMap": [
    {
      ...
      "usedFor": "Used directly or conceptually in JTR \u00b7 AI Job-Seeking Agent."
    },
    {
      "name": "Database",
      "category": "Project stack",
  ...
  "implementationDetails": [
    {
      "title": "Core workflow",
      "body": "Application tracking, role matching, skill mapping, and recommendation logic."
    },
    {
  ...
  "metrics": [
    {
      "label": "Role-match accuracy",
      "value": "88%",
      "note": "Percentage of recommended roles rated relevant by the user in test runs"
    },
    {
      "label": "Applications tracked",
      "value": "120+",
      "note": "Total job applications managed through the tracking workflow"
    }
  ],
  "gallery": [
    {
      "src": "/portfolio_images/stackmap/agentic-systems.jpg",
      "alt": "Project visual for JTR \u00b7 AI Job-Seeking Agent",
      "caption": "A polished visual summary of the project direction, technical stack, and product value."
    }
  ],
  "relatedProjectSlugs": [],
  "relatedPostSlugs": [],
  "impactTakeaway": "This page shows applied career tech work and gives the project enough room to be understood beyond a one-line card.",
  "interviewTalkingPoints": [
    "What problem JTR \u00b7 AI Job-Seeking Agent solves.",
    "Which stack choices mattered and why.",
    "What I would improve in the next iteration."
  ],
  "resumeBullets": [
    "Built JTR \u00b7 AI Job-Seeking Agent, applying AI-assisted product interface, Database, Recommendation Logic to a practical career tech workflow."
  ],
  "futureWork": [
