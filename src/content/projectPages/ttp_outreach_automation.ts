...
export const project: ProjectPageContent = {
  ...
  "problem": "This project deserves more than a small card. The page explains the practical business automation problem, why it matters, and what technical choices were made.",
  ...
  "impactTakeaway": "This page shows applied business automation work and gives the project enough room to be understood beyond a one-line card.",
  "interviewTalkingPoints": [
    "What problem TTP DNS Screening & Outreach Automation solves.",
