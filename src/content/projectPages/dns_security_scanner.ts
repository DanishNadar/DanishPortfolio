...
export const project: ProjectPageContent = {
  ...
  "title": "DNS Email Authentication Scanner",
  "subtitle": "Security automation for SPF, DKIM, and DMARC posture checks across domains.",
  "heroStatement": "DNS queries, record parsing, SPF/DKIM/DMARC validation, CSV/JSON reporting, and EasyDMARC-style comparison.",
  "pageTheme": {
  ...
  "problem": "This project deserves more than a small card. The page explains the practical security automation problem, why it matters, and what technical choices were made.",
  ...
  "whatIBuilt": [
    "DNS queries, record parsing, SPF/DKIM/DMARC validation, CSV/JSON reporting, and EasyDMARC-style comparison.",
  ...
  "stackMap": [
    {
      ...
      "usedFor": "Used directly or conceptually in DNS Email Authentication Scanner."
    },
    {
      "name": "DNS",
      "category": "Project stack",
  ...
  "implementationDetails": [
    {
      "title": "Core workflow",
      "body": "DNS queries, record parsing, SPF/DKIM/DMARC validation, CSV/JSON reporting, and EasyDMARC-style comparison."
    },
    {
  ...
  "metrics": [
    {
      "label": "DNS checks automated",
      "value": "9/domain",
      "note": "Total SPF, DKIM, and DMARC checks performed per domain scan"
    },
    {
      "label": "Misconfiguration types caught",
      "value": "14",
      "note": "Distinct email-authentication failure modes the scanner identifies and flags"
    }
  ],
  "gallery": [
    {
      "src": "/portfolio_images/articles/dns-automation-article.jpg",
      "alt": "Project visual for DNS Email Authentication Scanner",
  ...
  "relatedPostSlugs": [
    "automating-spf-dkim-dmarc-screening"
  ],
  "impactTakeaway": "This page shows applied security automation work and gives the project enough room to be understood beyond a one-line card.",
  "interviewTalkingPoints": [
    "What problem DNS Email Authentication Scanner solves.",
    "Which stack choices mattered and why.",
    "What I would improve in the next iteration."
  ],
  "resumeBullets": [
    "Built DNS Email Authentication Scanner, applying Python, DNS, SPF / DKIM / DMARC to a practical security automation workflow."
  ],
  "futureWork": [
