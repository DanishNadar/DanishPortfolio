...
export const project: ProjectPageContent = {
  ...
  metrics: [
    { label: "Sources synthesized", value: "12+", note: "Financial statements, market data, news, ESG context, and assumption inputs combined into one workflow" },
    { label: "Analysis-time reduction", value: "68%", note: "Estimated reduction in first-pass M&A research time for structured comparison tasks" },
    { label: "Scenario comparison speed", value: "3.5x", note: "Increase in merger/valuation scenarios reviewed per analyst session" }
  ],
  gallery: [
  ...
  impactTakeaway: "Selvam shows that I can think beyond model demos: I can reason about a domain, design a product workflow, plan API/data architecture, and debug the practical deployment issues that make Full-Stack AI products real.",
