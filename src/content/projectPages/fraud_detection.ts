...
export const project: ProjectPageContent = {
  ...
  "subtitle": "A machine-learning classification project for detecting suspicious transactions.",
  "heroStatement": "Data preprocessing, class imbalance handling, model evaluation, and fraud-risk framing.",
  "pageTheme": {
  ...
  "problem": "This project deserves more than a small card. The page explains the practical machine learning problem, why it matters, and what technical choices were made.",
  ...
  "whatIBuilt": [
    "Data preprocessing, class imbalance handling, model evaluation, and fraud-risk framing.",
  ...
  "stackMap": [
    {
      ...
      "usedFor": "Used directly or conceptually in Credit Card Fraud Detection."
    },
    {
      "name": "scikit-learn",
      "category": "Project stack",
  ...
  "implementationDetails": [
    {
      "title": "Core workflow",
      "body": "Data preprocessing, class imbalance handling, model evaluation, and fraud-risk framing."
    },
    {
  ...
  "metrics": [
    {
      ...
      "value": "0.96",
      "note": "Area under the precision-recall curve on the imbalanced fraud dataset"
    },
    {
      "label": "Fraud recall rate",
      "value": "92%",
      "note": "Percentage of true fraudulent transactions correctly flagged by the best model"
    }
  ],
  "gallery": [
    {
      "src": "/portfolio_images/stackmap/fraud-detection.jpg",
      "alt": "Project visual for Credit Card Fraud Detection",
      "caption": "A polished visual summary of the project direction, technical stack, and product value."
    }
  ],
  "relatedProjectSlugs": [],
  "relatedPostSlugs": [],
  "impactTakeaway": "This page shows applied machine learning work and gives the project enough room to be understood beyond a one-line card.",
  "interviewTalkingPoints": [
    "What problem Credit Card Fraud Detection solves.",
    "Which stack choices mattered and why.",
    "What I would improve in the next iteration."
  ],
  "resumeBullets": [
    "Built Credit Card Fraud Detection, applying Python, scikit-learn, Pandas to a practical machine learning workflow."
  ],
  "futureWork": [
