      ...
      <ReactMarkdown
        ...
        components={{
          ...
          img: ({ src, alt }) => {
            ...
            const imageAlt = alt ?? "Article visual";
            return (
              <span className="zoomable-image-wrap my-8 block aspect-video w-full rounded-3xl">
                <img
                  src={imageSrc}
                  alt={imageAlt}
                  loading="lazy"
                  className="h-full w-full rounded-3xl border border-border/70 object-cover shadow-2xl shadow-blue-950/40"
                />
