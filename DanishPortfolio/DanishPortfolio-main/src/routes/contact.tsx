...
const contactCards = [
  ...
  { title: "Speaking / workshops", body: "Workshops on AI/ML, robotics, technical storytelling, LinkedIn/resume strategy, Python, Linux, and project-building for student teams.", icon: MessageSquare },
];
