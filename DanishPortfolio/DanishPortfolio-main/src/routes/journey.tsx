...
const chapters = [
  ...
  },
  {
    phase: "03",
    label: "Turning Point",
    title: "A traffic collision made the mission deeply personal.",
  ...
  },
  {
    phase: "05",
    label: "Acceleration",
    title: "Illinois Tech turned recovery into disciplined, purposeful engineering.",
    body: "At Illinois Tech, recovery became momentum through robotics, EcoCAR, leadership, automation, and applied AI.",
    color: "blue",
  },
  {
    phase: "06",
...
const pathGroups = [
  ...
  },
  {
    ...
    groupDesc: "The habits of service, clarity, and follow-through behind strong teams.",
    color: "red" as const,
    icon: Star,
    pages: [
      {
      ...
      },
      {
        ...
        body: "EcoCAR, robotics, and IIT communities where engineering became shared work.",
        tags: ["EcoCAR", "Clubs", "Community", "Collaboration"],
        accent: "purple",
      },
    ],
  },
...
const displayedPathGroups = [
  pathGroups.find((group) => group.id === "people")!,
  ...pathGroups.filter((group) => group.id !== "people"),
];
...
const accentMap = {
  blue: {
    ...
    sectionBg: "bg-[radial-gradient(ellipse_at_0%_30%,rgba(59,130,246,0.11),transparent_60%),radial-gradient(ellipse_at_100%_80%,rgba(59,130,246,0.05),transparent_50%)]",
  },
  cyan: {
  ...
  red: {
    ...
    sectionBg: "bg-[radial-gradient(ellipse_at_100%_20%,rgba(200,30,70,0.12),transparent_60%),radial-gradient(ellipse_at_0%_90%,rgba(200,30,70,0.05),transparent_50%)]",
  },
  purple: {
...
function JourneyPage() {
  return (
    <MotionPage mood="hero" className="mx-auto max-w-7xl px-6 py-16">
      ...
      >
        ...
        <h1 className="text-5xl md:text-6xl lg:text-7xl font-display font-bold leading-[1.04] animated-title-glow">
          The path that shaped{" "}
          <span className="text-gradient-rb">the engineer.</span>
        </h1>
        <p className="mt-6 text-xl leading-relaxed text-muted-foreground max-w-3xl">
          ...
          Illinois Tech gave it direction. This is the story behind the work.
        </p>
      ...
      <SectionReveal className="mt-20">
        <section className="rounded-[2rem] border border-border/70 bg-background/25 p-6 md:p-10 overflow-hidden relative">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_20%_0%,rgba(59,130,246,0.08),transparent_50%),radial-gradient(ellipse_at_80%_100%,rgba(200,30,70,0.07),transparent_50%)]" aria-hidden="true" />
                ...
                {chapters.map((c, i) => (
                  ...
                  >
                    ...
                    <div className="glass premium-border rounded-2xl p-5 md:p-6">
                      <div className={`text-[10px] uppercase tracking-[0.2em] font-tech mb-2 ${phaseColors[c.color as keyof typeof phaseColors]}`}>
                        {c.label}
                      </div>
        ...
        return (
          <SectionReveal key={group.id} className="mt-16" delay={gi * 0.05}>
            <section className="rounded-[2rem] border border-border/70 p-6 md:p-8 relative overflow-hidden">
              <div className={`absolute inset-0 rounded-[2rem] ${groupColors.sectionBg}`} aria-hidden="true" />
              <div className="relative z-10">
              {/* Group header */}
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="flex items-start justify-between gap-3 mb-5">
                          <div className={`grid h-12 w-12 place-items-center rounded-2xl ${colors.icon}`}>
                            <PageIcon className="h-6 w-6" />
                          </div>
                          <span className={`text-[10px] uppercase tracking-[0.16em] font-tech px-2.5 py-1 rounded-full ${colors.badge}`}>
                            {page.eyebrow}
                          </span>
                        </div>
      ...
      <SectionReveal className="mt-16">
        <section className="rounded-[2rem] border border-border/70 bg-background/25 p-8 md:p-10 relative">
          <div className="absolute inset-0 rounded-[2rem] overflow-hidden pointer-events-none">
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_60%_0%,rgba(59,130,246,0.1),transparent_55%),radial-gradient(ellipse_at_30%_100%,rgba(200,30,70,0.08),transparent_50%)]" aria-hidden="true" />
          </div>
          <div className="relative z-10 grid lg:grid-cols-[1fr_260px] gap-8 items-start">
            <div>
              ...
              <p className="text-base leading-8 text-muted-foreground max-w-2xl">
                ...
                matters. Together they describe an engineer who builds with both technical depth
                and human purpose.
              </p>
            </div>
