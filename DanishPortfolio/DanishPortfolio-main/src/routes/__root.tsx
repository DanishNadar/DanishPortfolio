...
const FloatingAvatar = lazy(() => import("@/components/FloatingAvatar").then((mod) => ({ default: mod.FloatingAvatar })));
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "AI engineer building robotics, autonomy, and intelligent products from idea to working prototype." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Goldman:wght@400;700&family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;600&family=Orbitron:wght@500;600;700;800&family=Science+Gothic:wght@400;500;600;700;800;900&family=Zen+Dots&display=swap" },
    ],
  }),
  ...
  notFoundComponent: () => (
    <div className="min-h-screen grid place-items-center px-6">
      <div className="text-center">
        ...
        <Link to="/" className="mt-6 inline-block px-5 py-2 rounded-lg bg-gradient-rb text-background font-semibold">Back home</Link>
      </div>
    </div>
  ),
