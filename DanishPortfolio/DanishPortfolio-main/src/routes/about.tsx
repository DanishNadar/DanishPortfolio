...
const thinking = [
  ...
  ["I care about usefulness after the demo.", "A demo can look polished and still be fragile. I try to ask what breaks in real use, what assumptions are hidden, which signal can be trusted, and how the system would be explained to a teammate, recruiter, or user."],
  ...
  ["I like work that carries both depth and meaning.", "EcoCAR has real-time vehicle integration. TTP has security automation and reporting. Accessibility robotics has a human reason at the center. I want the portfolio to show not just what was built, but what each project taught me about responsibility."],
];
...
function About() {
  return (
    <MotionPage mood="hero" className="mx-auto max-w-7xl px-6 py-16 readable-page">
