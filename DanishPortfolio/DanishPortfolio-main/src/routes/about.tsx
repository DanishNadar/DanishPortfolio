...
const focusAreas = [
  ...
  ["Security automation", "SPF/DKIM/DMARC screening, DNS automation, reporting, Streamlit workflows, and Microsoft Graph outreach.", "/projects/dns-security-scanner"],
];
...
const thinking = [
  ...
  ["I care about usefulness beyond the demo.", "A demo can be impressive and still not be reliable. I try to ask what breaks in real use, what assumptions are hidden, which signal can be trusted, and how the system would be explained to a teammate, recruiter, or user."],
...
const achievements = [
  ...
  {
    id: "A-02",
    title: "Illinois Tech Robotics President",
    body: "Led Illinois Tech Robotics through lab organization, project planning, workshops, budgeting, safety conversations, and efforts to build a more inclusive engineering community.",
    image: {
      id: "A-02",
  ...
  return (
    <MotionPage className="mx-auto max-w-7xl px-6 py-16 readable-page">
      <section className="grid lg:grid-cols-[1fr_1.1fr] gap-12 items-center">
        ...
        <div>
          <div className="inline-flex items-center gap-2 glass px-4 py-2 rounded-full text-sm text-accent"><Sparkles className="h-4 w-4" /> AI engineer at the intersection of robotics, autonomy, and product</div>
          ...
          <p className="mt-6 text-xl leading-relaxed text-muted-foreground">My work sits between research, engineering, and product, built through open-source tooling and terminal-driven workflows: autonomous-vehicle pipelines, accessibility robotics, applied machine learning, security automation, and portfolio-grade AI interfaces. I care about building things that are technically real, explainable to people, and useful beyond a demo.</p>
        ...
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-4 max-w-3xl text-lg leading-8 text-muted-foreground">
              This section is meant to quickly show wins, leadership moments, technical accomplishments, and personal accomplishments without making visitors dig through every project page first.
            </p>
          </div>
      ...
      <section className="mt-20 glass rounded-3xl p-8 md:p-10 premium-border">
        ...
        <p className="mt-4 text-lg leading-8 text-muted-foreground max-w-4xl">I am especially interested in roles and collaborations where I can combine AI/ML, robotics/autonomy, backend systems, AI tooling, and product thinking to build real tools, not just isolated demos.</p>
