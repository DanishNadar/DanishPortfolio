...
const gallerySlots = [
  ...
  ["G-06", "Won the world's largest hardware hackathon", "StarkHacks 2026 — Qualcomm Robotics Track. Use the winner certificate, award moment, team photo, demo table, or OBSERV-E showcase image.", "/portfolio_images/gallery/danish-starkhacks-certificate.png"],
    ...
    <MotionPage className="mx-auto max-w-[96rem] px-6 lg:px-10 py-14 readable-page">
      <section className="text-center max-w-4xl mx-auto">
        ...
        <h1 className="mt-5 text-4xl md:text-6xl font-display font-bold animated-title-glow">
          A visual proof wall for the work, people, and moments behind the <span className="text-gradient-rb">engineering story</span>.
        </h1>
        <p className="mt-6 text-xl leading-relaxed text-muted-foreground">
          This gallery turns the portfolio into evidence: robotics labs, autonomy work, leadership moments, technical diagrams, community impact, and the creative discipline behind the engineering.
        </p>
      ...
      <section className="mt-16">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-3 text-3xl md:text-4xl font-display font-bold">Visual proof across projects, leadership, and life</h2>
          </div>
      ...
      <section className="mt-16 glass premium-border rounded-3xl p-8 md:p-10">
        ...
        <h2 className="mt-3 text-3xl font-display font-bold">The work is technical, but the story is human.</h2>
        <p className="mt-4 max-w-4xl text-base leading-8 text-muted-foreground">
          These images are here to help a recruiter or engineering manager understand the full pattern: I build systems, lead teams, learn quickly, document what matters, and connect technology back to people. The visuals are intentionally organized as proof points instead of decoration.
        </p>
      </section>
    </MotionPage>
  );
