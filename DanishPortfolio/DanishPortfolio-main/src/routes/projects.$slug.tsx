...
function ProjectTestimonials({ title, stackNames }: { title: string; stackNames: string[] }) {
  ...
  const cards = [
    ...
    },
    {
      ...
      quote: `This project gives a hiring team more than a keyword list: it connects judgment across ${primaryStack} to outcomes that had to be useful, explainable, and grounded.`,
    },
    {
      lens: "Leadership signal",
      quote:
        "The work is documented so a teammate, mentor, recruiter, or technical reviewer can follow both the engineering decisions and the responsibility behind the build.",
    },
  ];
  return (
