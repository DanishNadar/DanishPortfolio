...
export const project: ProjectPageContent = {
  "slug": "shopping-bot",
  "title": "Automated Shopping Bot",
  "subtitle": "A shopping assistant concept for comparing items and guiding product decisions.",
  "heroStatement": "Search/compare flow, chatbot interaction, product filtering, and decision support.",
  "pageTheme": {
    "eyebrow": "Agentic Tools",
  ...
  "problem": "This project deserves more than a small card. The page explains the practical agentic tools problem, why it matters, and what technical choices were made.",
  ...
  "whatIBuilt": [
    "Search/compare flow, chatbot interaction, product filtering, and decision support.",
  ...
  "stackMap": [
    {
      ...
      "usedFor": "Used directly or conceptually in Automated Shopping Bot."
    },
    {
      "name": "APIs",
      "category": "Project stack",
  ...
  "implementationDetails": [
    {
      "title": "Core workflow",
      "body": "Search/compare flow, chatbot interaction, product filtering, and decision support."
    },
    {
  ...
  "metrics": [
    {
      "label": "Product sources scraped",
      "value": "—",
      "note": "Number of distinct retailers or APIs the bot queries for product comparison"
    },
    {
      "label": "Decision support accuracy",
      "value": "—",
      "note": "Rate at which bot recommendations matched the user's final purchase choice in test sessions"
    }
  ],
  "gallery": [
    {
      "src": "/portfolio_images/stackmap/selenium.jpg",
      "alt": "Project visual for Automated Shopping Bot",
      "caption": "A polished visual summary of the project direction, technical stack, and product value."
    }
  ],
  "relatedProjectSlugs": [],
  "relatedPostSlugs": [],
  "recruiterTakeaway": "This page shows applied agentic tools work and gives the project enough room to be understood beyond a one-line card.",
  "interviewTalkingPoints": [
    "What problem Automated Shopping Bot solves.",
    "Which stack choices mattered and why.",
    "What I would improve in the next iteration."
  ],
  "resumeBullets": [
    "Built Automated Shopping Bot, applying Chatbot Logic, APIs, Product interface to a practical agentic tools workflow."
  ],
  "futureWork": [
