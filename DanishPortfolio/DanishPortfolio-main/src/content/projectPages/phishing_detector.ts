...
export const project: ProjectPageContent = {
  ...
  "problem": "This project deserves more than a small card. The page explains the practical security ml problem, why it matters, and what technical choices were made.",
  ...
  "relatedPostSlugs": [],
  "recruiterTakeaway": "This page shows applied security ml work and gives the project enough room to be understood beyond a one-line card.",
  "interviewTalkingPoints": [
    "What problem Phishing Detection Model solves.",
