...
export const project: ProjectPageContent = {
  ...
  "title": "AI Headshot Platform Contribution",
  "subtitle": "A product/AI image workflow concept for professional headshot generation.",
  "heroStatement": "Image workflow, AI-assisted product review, user experience, and backend API concepts.",
  "pageTheme": {
    "eyebrow": "AI Product",
  ...
  "problem": "This project deserves more than a small card. The page explains the practical AI product problem, why it matters, and what technical choices were made.",
  ...
  "whatIBuilt": [
    "Image workflow, AI-assisted product review, user experience, and backend API concepts.",
  ...
  "stackMap": [
    {
      "name": "AI-assisted product interface",
      "category": "Project stack",
      "usedFor": "Used directly or conceptually in AI Headshot Platform Contribution."
    },
    {
  ...
  "implementationDetails": [
    {
      "title": "Core workflow",
      "body": "Image workflow, AI-assisted product review, user experience, and backend API concepts."
    },
    {
  ...
  "metrics": [
    {
      "label": "Image generation pipeline stages",
      "value": "—",
      "note": "Number of distinct steps from user photo upload to final headshot output"
    },
    {
      "label": "Output quality review pass rate",
      "value": "—",
      "note": "Percentage of AI-generated headshots passing quality review without manual correction"
    }
  ],
  "gallery": [
    {
      "src": "/portfolio_images/articles/ai-avatar-pipeline.jpg",
      "alt": "Project visual for AI Headshot Platform Contribution",
      "caption": "A polished visual summary of the project direction, technical stack, and product value."
    }
  ],
  "relatedProjectSlugs": [],
  "relatedPostSlugs": [],
  "recruiterTakeaway": "This page shows applied AI product work and gives the project enough room to be understood beyond a one-line card.",
  "interviewTalkingPoints": [
    "What problem AI Headshot Platform Contribution solves.",
    "Which stack choices mattered and why.",
    "What I would improve in the next iteration."
  ],
  "resumeBullets": [
    "Built AI Headshot Platform Contribution, applying AI-assisted product interface, Image Processing, Backend API to a practical AI product workflow."
  ],
  "futureWork": [
