...
export const project: ProjectPageContent = {
  "slug": "scammantha",
  "title": "Scammantha Scam Awareness Game",
  "subtitle": "A safety-focused AI scam simulation game for learning scam warning signs.",
  "heroStatement": "Conversational scam simulation, safe training scenarios, UI/game flow, and responsible AI framing.",
  "pageTheme": {
  ...
  "problem": "This chapter explains the practical security education problem, why it matters to people or teams, and what technical choices helped turn the idea into something more useful.",
  ...
  "whatIBuilt": [
    "Conversational scam simulation, safe training scenarios, UI/game flow, and responsible AI framing.",
  ...
  "stackMap": [
    {
      ...
      "usedFor": "Used directly or conceptually in Scammantha Scam Awareness Game."
    },
    {
  ...
  "implementationDetails": [
    {
      "title": "Core workflow",
      "body": "Conversational scam simulation, safe training scenarios, UI/game flow, and responsible AI framing."
    },
    {
  ...
  "metrics": [
    {
      "label": "Scam scenario types",
      "value": "—",
      "note": "Number of distinct scam archetypes (romance, tech support, phishing, etc.) simulated in the game"
    },
    {
      "label": "User warning-sign recognition rate",
      "value": "—",
      "note": "Percentage of red-flag cues correctly identified by players in playtesting sessions"
    }
  ],
  "gallery": [
    {
      "src": "/portfolio_images/articles/scammantha-article.jpg",
      "alt": "Project visual for Scammantha Scam Awareness Game",
  ...
  "relatedPostSlugs": [
    "scammantha-scam-awareness-game"
  ],
  "recruiterTakeaway": "This chapter shows applied security education work as part of a broader pattern: frame the problem, build carefully, learn honestly, and connect the result to people who can use it.",
  "interviewTalkingPoints": [
    "What problem Scammantha Scam Awareness Game tries to serve.",
    "Which stack choices mattered, and where the tradeoffs showed up.",
    "What I would rebuild or strengthen in the next iteration."
  ],
  "resumeBullets": [
    "Built Scammantha Scam Awareness Game, applying Game UI, AI Conversation, Security Awareness to a practical security education workflow."
  ],
  "futureWork": [
