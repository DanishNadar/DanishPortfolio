...
export const project: ProjectPageContent = {
  ...
  "problem": "This project deserves more than a small card. The page explains the practical security education problem, why it matters, and what technical choices were made.",
  ...
  "recruiterTakeaway": "This page shows applied security education work and gives the project enough room to be understood beyond a one-line card.",
  "interviewTalkingPoints": [
    "What problem Scammantha Scam Awareness Game solves.",
