...
export const project: ProjectPageContent = {
  ...
  "title": "Spiron Virtual Assistant",
  "subtitle": "A personal assistant concept for automating tasks and surfacing project context.",
  "heroStatement": "Local automation, AI assistant workflows, command routing, and knowledge lookup.",
  "pageTheme": {
  ...
  "problem": "This chapter explains the practical AI assistant problem, why it matters to people or teams, and what technical choices helped turn the idea into something more useful.",
  ...
  "whatIBuilt": [
    "Local automation, AI assistant workflows, command routing, and knowledge lookup.",
  ...
  "stackMap": [
    {
      ...
      "usedFor": "Used directly or conceptually in Spiron Virtual Assistant."
    },
    {
      "name": "Production App Workflows",
      "category": "Project stack",
      "usedFor": "Used directly or conceptually in Spiron Virtual Assistant."
    },
    {
  ...
  "implementationDetails": [
    {
      "title": "Core workflow",
      "body": "Local automation, AI assistant workflows, command routing, and knowledge lookup."
    },
    {
  ...
  "metrics": [
    {
      "label": "Automatable commands routed",
      "value": "—",
      "note": "Number of distinct task types the assistant can dispatch without manual intervention"
    },
    {
      "label": "Intent resolution accuracy",
      "value": "—",
      "note": "Percentage of user queries correctly classified and routed to the right handler"
    }
  ],
  "gallery": [
    {
      "src": "/portfolio_images/stackmap/agentic-systems.jpg",
      "alt": "Project visual for Spiron Virtual Assistant",
  ...
  "relatedPostSlugs": [],
  "recruiterTakeaway": "This chapter shows applied AI assistant work as part of a broader pattern: frame the problem, build carefully, learn honestly, and connect the result to people who can use it.",
  "interviewTalkingPoints": [
    "What problem Spiron Virtual Assistant tries to serve.",
    "Which stack choices mattered, and where the tradeoffs showed up.",
    "What I would rebuild or strengthen in the next iteration."
  ],
  "resumeBullets": [
    "Built Spiron Virtual Assistant, applying Python, Production App Workflows, Automation to a practical AI assistant workflow."
  ],
  "futureWork": [
