...
export const project: ProjectPageContent = {
  ...
  metrics: [
    { label: "Primary audience", value: "Older adults", note: "Baby boomers and families needing patient technology guidance" },
    { label: "Content modes", value: "3", note: "Chat answers, short videos, and private consulting" },
  ...
  recruiterTakeaway: "This project shows product judgment, audience empathy, AI tool fluency, voice-model integration planning, and the ability to turn an underserved user problem into a practical AI software concept.",
