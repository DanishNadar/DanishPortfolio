  ...
  return (
    <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none" aria-hidden="true">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="bg-system-flow bg-system-flow-top">Curiosity → Survival → Recovery → AI Engineering → Impact</div>
        <div className="bg-system-flow bg-system-flow-bottom">Sense → Model → Build → Validate → Empower</div>
      </div>
