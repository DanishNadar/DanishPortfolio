...
export const projectDetails: Record<string, ProjectDetail> = {
  ...
  "lane-detection-salad": {
    ...
    metrics: [
      ...
      { label: "Evaluation metrics", value: "4" },
    ],
    interviewPoints: [
  ...
  "ttp-outreach-automation": {
    ...
    recruiterTakeaway: "Shows the ability to turn a technical security scanner into an operational product workflow with API integration, UI controls, and business-facing reliability.",
